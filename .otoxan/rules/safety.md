...
3. Browser-local TypeScript commands and immutable revision state are the sole writable Stage 1 product authority. Tracked Python/build123d material is pre-cutover legacy, not a current product, adapter, backend, verification authority, or writable authority.
