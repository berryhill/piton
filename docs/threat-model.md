...
10. The current candidate implements and executes a closed 25-scenario browser behavior corpus and deterministic 1,000-schedule browser failure/concurrency campaign. This closes only that candidate-bound browser evidence slice; broader Stage 1/G2 acceptance, browser/OS/GPU/accessibility qualification, exact-adapter coverage, and independent human review remain incomplete.
